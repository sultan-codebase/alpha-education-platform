...
export const useStudentStore = defineStore('student', {
  ...
  actions: {
    ...
    async fetchStudents() {
      ...
      if (!this.list.length) {
        this.list = [
          { id: 1, name: 'Ахметова Айдана Данибековна',    iin: '990101350128', course: 'Data Science',                     stream: 'A1', topStudent: false, email: 'aidana@example.com',   phone: '+7 700 000 00 01', status: 'active' },
          { id: 2, name: 'Талгатов Али Ермекович',         iin: '870213400917', course: 'Generative AI',                   stream: 'B2', topStudent: true,  email: 'ali@example.com',      phone: '+7 700 000 00 02', status: 'active' },
